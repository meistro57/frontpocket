...
func (s *Server) openAPISpec() map[string]any {
	...
	spec := map[string]any{
		...
		"paths": map[string]any{
			...
			"/memory/stats": map[string]any{
				"get": map[string]any{
					...
					"parameters": []map[string]any{
						...
						{"$ref": "#/components/parameters/aiProviderFilter"},
						{"$ref": "#/components/parameters/aiModelFilter"},
						{"$ref": "#/components/parameters/starredFilter"},
						{"$ref": "#/components/parameters/sharedFilter"},
						{"$ref": "#/components/parameters/feedbackRatingFilter"},
						{"$ref": "#/components/parameters/hasAttachmentFilter"},
			...
			"/memory/browse": map[string]any{
				"get": map[string]any{
					"operationId": "browseMemory",
					"summary":     "Browse memory records by filters",
					"parameters": []map[string]any{
						{"$ref": "#/components/parameters/limitFilter"},
						{"$ref": "#/components/parameters/offsetFilter"},
						{"$ref": "#/components/parameters/sinceFilter"},
						{"$ref": "#/components/parameters/untilFilter"},
						{"$ref": "#/components/parameters/includeCanonicalFilter"},
						{"$ref": "#/components/parameters/projectFilter"},
						{"$ref": "#/components/parameters/memoryKindFilter"},
						{"$ref": "#/components/parameters/speakerFilter"},
						{"$ref": "#/components/parameters/sourceTypeFilter"},
					...
					"responses": map[string]any{
						"200": map[string]any{
							"description": "Browse result page.",
							"content": map[string]any{
								"application/json": map[string]any{
									"schema": map[string]any{"type": "object"},
								},
		...
		"components": map[string]any{
			...
			"parameters": map[string]any{
				"limitFilter": map[string]any{
					"in":          "query",
					"name":        "limit",
					"required":    false,
					"description": "Page size for browse responses.",
					"schema":      map[string]any{"type": "integer", "minimum": 1, "maximum": 500},
				},
				"offsetFilter": map[string]any{
					"in":          "query",
					"name":        "offset",
					"required":    false,
					"description": "Opaque browse cursor returned by the previous page.",
				...
				"sinceFilter": map[string]any{
					...
					"name":        "since",
					"required":    false,
					"description": "Only include records on or after this date/time (RFC3339 or YYYY-MM-DD).",
					"schema":      map[string]any{"type": "string"},
				},
				"untilFilter": map[string]any{
					"in":          "query",
					"name":        "until",
					"required":    false,
					"description": "Only include records on or before this date/time (RFC3339 or YYYY-MM-DD).",
					"schema":      map[string]any{"type": "string"},
				},
				"includeCanonicalFilter": map[string]any{
					"in":          "query",
					"name":        "include_canonical",
					"required":    false,
					"description": "Include canon memories in browse results.",
				...
				"aiProviderFilter": map[string]any{
					"in":          "query",
					"name":        "ai_provider",
					"required":    false,
				...
				"sharedFilter": map[string]any{
					...
					"name":        "shared",
					"required":    false,
					"description": "Filter by shared state.",
					"schema":      map[string]any{"type": "boolean"},
				},
				"feedbackRatingFilter": map[string]any{
					"in":          "query",
					"name":        "feedback_rating",
					"required":    false,
					"description": "Filter by feedback rating.",
					"schema":      map[string]any{"type": "string"},
				},
				"hasAttachmentFilter": map[string]any{
					"in":          "query",
					"name":        "has_attachment",
					"required":    false,
			...
			"schemas": map[string]any{
				...
				"SearchFilters": map[string]any{
					...
					"properties": map[string]any{
						...
						"ai_provider":     map[string]any{"type": "string"},
						"ai_model":        map[string]any{"type": "string"},
						"user_starred":    map[string]any{"type": "boolean"},
						"user_shared":     map[string]any{"type": "boolean"},
						"feedback_rating": map[string]any{"type": "string"},
