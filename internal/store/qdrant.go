...
func toQdrantPayload(point memory.MemoryPoint) map[string]any {
	payload := map[string]any{
		...
		"tags":                     point.Tags,
		"user_starred":             point.UserStarred,
		"user_shared":              point.UserShared,
		"share_id":                 point.ShareID,
		"feedback_rating":          point.FeedbackRating,
		"feedback_note":            point.FeedbackNote,
		"feedback_at":              point.FeedbackAt,
		"attachment_filename":      point.AttachmentFilename,
		"attachment_mime_type":     point.AttachmentMimeType,
		"attachment_category":      point.AttachmentCategory,
		"attachment_source_system": point.AttachmentSourceSystem,
